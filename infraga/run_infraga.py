...
@click.option("--wvfrm-yield", help="Eq. TNT yield for an explosive source", default=None)
...
def run_2d_wvfrm(config_file, atmo_file, inclination, azimuth, bounces, src_alt, write_ray, wvfrm_file, wvfrm_opt,
                wvfrm_p0, wvfrm_t0, wvfrm_alpha, wvfrm_ref, wvfrm_out_step, wvfrm_yield, freq, abs_coeff, z_grnd, 
                write_atmo, output_id, max_alt, max_rng, min_ds, max_ds, max_s, topo_file, topo_bl_wind):
    '''
...
def run_3d_wvfrm(config_file, atmo_file, atmo_prefix, grid_lats, grid_lons, inclination, azimuth, bounces, src_x, src_y, 
                ...
                wvfrm_yield, freq, abs_coeff, z_grnd, write_atmo, output_id, max_alt, max_rng, min_x, max_x, min_y, max_y, 
...
def run_sph_wvfrm(config_file, atmo_file, atmo_prefix, grid_lats, grid_lons, inclination, azimuth, bounces, src_lat, src_lon, 
                src_alt, write_ray, wvfrm_file, wvfrm_opt, wvfrm_p0, wvfrm_t0, wvfrm_alpha, wvfrm_ref, wvfrm_out_step,
                wvfrm_yield, freq, abs_coeff, z_grnd, write_atmo, output_id, max_alt, max_rng, max_lat, min_lat, max_lon, 
