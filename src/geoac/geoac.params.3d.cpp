...
double  geoac::s_max = 5000.0;  // Ray length at which to stop ray tracing
...
double 	geoac::x_min = -2000.0;     // E-W range at which to stop ray tracing
double 	geoac::x_max =  2000.0;     // E-W range at which to stop ray tracing
double 	geoac::y_min = -2000.0;     // N-S range at which to stop ray tracing
double 	geoac::y_max =  2000.0;     // N-S range at which to stop ray tracing
