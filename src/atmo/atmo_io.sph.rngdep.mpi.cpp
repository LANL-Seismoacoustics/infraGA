...
//--------------Interpolations---------------//
//-------------------------------------------//
int set_region(char* atmo_prefix, char* atmo_locs_lat, char* atmo_locs_lon, char* atmo_format, bool invert_winds, int rank){
    int result = 1;
    if(rank == 0){
...
int set_region(char* atmo_prefix, char* atmo_locs_lat, char* atmo_locs_lon, char* topo_file, char* atmo_format, bool invert_winds, int rank){
    int result = 1;
    if(rank == 0){
