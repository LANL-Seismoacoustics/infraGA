...
//--------------Interpolations---------------//
//-------------------------------------------//
int set_region(char*, char*, char*, char*, bool);          // Read in the atmosphere file and set up interpolations
int set_region(char*, char*, char*, char*, char*, bool);   // Read in the atmosphere and topography files and set up interpolations

int set_region(char*, char*, char*, char*, bool, int);          // Read in the atmosphere file and set up interpolations using OpenMPI
int set_region(char*, char*, char*, char*, char*, bool, int);   // Read in the atmosphere and topography files and set up interpolations using OpenMPI
